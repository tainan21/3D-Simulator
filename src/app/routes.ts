...
export const SURFACE_META: SurfaceMeta[] = [
  ...
  { id: "characters", route: "/characters", title: "Personagens", shortTitle: "Chars", role: "editing", description: "Studio geometrico de personagens, mobs, boss, ataques e padroes." },
  { id: "character-forge", route: "/character-forge", title: "Character Forge", shortTitle: "Forge", role: "editing", description: "Criacao premium de DNA visual e funcional para entidades geometricas." },
...
const loaderEntries: Array<[AppRoute, SurfaceLoader]> = [
  ...
  ["/characters", () => import("./surfaces/characterStudioSurface").then((module) => module.default)],
  ["/character-forge", () => import("./surfaces/characterForgeSurface").then((module) => module.default)],
